...
object TransactionEngineTemplates {
    ...
    val templates = Seq(
        ...
        MessageTemplate.createWithDynamicSubject(
            ...
            fromAddress = transactionEngineAddress,
            service = ServiceIdentifier.PayeRTI,
            subject = extractSubject(_),
        ...
        MessageTemplate.createWithDynamicSubject(
            ...
            fromAddress = transactionEngineAddress,
            service = ServiceIdentifier.PayAsYouEarn,
            subject = extractSubject(_),
        ...
        MessageTemplate.createWithDynamicSubject(
            ...
            fromAddress = transactionEngineAddress,
            service = ServiceIdentifier.PensionSchemeAdministrators,
            subject = extractSubject(_),
